            ...
            <tr>
                <td style="padding: 40px;">
                    ...
                    <p style="margin: 0 0 18px; line-height: 1.6;">
                        ...
                        ha sido aprobado después de completar el proceso de revisión.
                    </p>

                    <p style="margin: 0 0 25px; line-height: 1.6;">
                        El curso ya puede continuar con el siguiente paso dentro de WebCIS.
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            <td style="border-left: 4px solid #2563eb; background-color: #eff6ff; padding: 16px 20px;">
